...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LexicalNodes_0BBACD5C".
 */
export type LexicalNodes_0BBACD5C =
  | SerializedTextNode
  | SerializedTabNode
  | SerializedLineBreakNode
  | SerializedParagraphNode<LexicalNodes_0BBACD5C>
  | SerializedHorizontalRuleNode
  | SerializedHeadingNode<LexicalNodes_0BBACD5C, 'h1' | 'h2' | 'h3' | 'h4'>
  | SerializedUploadNode<'media'>
  | SerializedQuoteNode<LexicalNodes_0BBACD5C>
  | SerializedRelationshipNode<
      ...
      | 'payload-migrations'
    >
  | SerializedAutoLinkNode<LexicalNodes_0BBACD5C, LexicalLinkFields>
  | SerializedLinkNode<LexicalNodes_0BBACD5C, LexicalLinkFields>
  | SerializedListNode<LexicalNodes_0BBACD5C>
  | SerializedListItemNode<LexicalNodes_0BBACD5C>;
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LexicalNodes_D742BE9E".
 */
export type LexicalNodes_D742BE9E =
  | SerializedTextNode
  | SerializedTabNode
  | SerializedLineBreakNode
  | SerializedParagraphNode<LexicalNodes_D742BE9E>
  | SerializedHorizontalRuleNode
  | SerializedUploadNode<'media'>
  | SerializedQuoteNode<LexicalNodes_D742BE9E>
  | SerializedRelationshipNode<
      | 'articles'
      | 'users'
      | 'topics'
      ...
      | 'payload-migrations'
    >
  | SerializedAutoLinkNode<LexicalNodes_D742BE9E, LexicalLinkFields>
  | SerializedLinkNode<LexicalNodes_D742BE9E, LexicalLinkFields>
  | SerializedListNode<LexicalNodes_D742BE9E>
  | SerializedListItemNode<LexicalNodes_D742BE9E>
  | SerializedHeadingNode<LexicalNodes_D742BE9E>;
...
/**
 * Organize and manage your blog articles here.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Article {
  ...
  title: string;
  body: LexicalRichText<LexicalNodes_0BBACD5C>;
  meta?: {
    title?: string | null;
    /**
...
/**
 * Organize and manage your topics here.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Topic {
  ...
  slug: string;
  name: string;
  description: LexicalRichText<LexicalNodes_0BBACD5C>;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface Media {
  id: number;
  alt: string;
  caption?: LexicalRichText<LexicalNodes_D742BE9E> | null;
  updatedAt: string;
  createdAt: string;
  url?: string | null;
...
export interface CollectionQueryWidget {
  data?: {
    title?: string | null;
    relatedCollection: 'articles' | 'users' | 'topics' | 'media';
    where?:
      | {
          [k: string]: unknown;
        }
...
export interface ActivityWidget {
  data?: {
    excludedCollections?: ('articles' | 'users' | 'topics' | 'media')[] | null;
  };
  width: 'x-small' | 'small' | 'medium' | 'large' | 'x-large' | 'full';
}
/**
